...
def solve_standard_problem():
    r = solve_multi_period_fpl(
        team_id=2821496, gw=16, ft=1, horizon=3, objective='regular')
    print(r['picks'])
    print(r['summary'])
...
def solve_autobench_problem():
    ...
    r = solve_multi_period_fpl(team_id=2821496, gw=16, ft=1,
...
def solve_randomized_problem():
    r = solve_multi_period_fpl(team_id=2821496, gw=17, ft=1,
